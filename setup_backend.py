#!/usr/bin/env python3
"""
NotesNest Backend Setup Script
Creates all necessary backend files and directories
"""
...
export const uploadNote = async (req, res) => {
  try {
    ...
    const note = new Note({ title, subject, semester: parseInt(semester), branch, unit, pdfLink: req.file.path, uploadedBy: req.userId });
    await note.save();
...
print(f"\n✅ Backend setup complete! Created {created_count} files")
